...
const RenewLicenseString = ({ open, handleClose, data, functionalities, setRestaurant }) => {
    console.log(data);
    const lastEndDate = data.licenseEndDate;
    const [restaurantData, setRestaurantData] = useState(data);
    const [errMsg, setErrMsg] = useState("");
    const { licenseId, licenseType, functionalityId, licenseEndDate, userLimit, itemLimit } = restaurantData;
    ...
    const onChange = (e) => {
        ...
        if (id === 'licenseEndDate') {
            value = moment(lastEndDate).add(value, 'days').format('YYYY-MM-DD')
        }
    ...
    const handleFormSubmit = () => {
        ...
        ApiPost('licString', restaurantData).then((res) => {
            handleClose();
            setRestaurant();
...
export default RenewLicenseString