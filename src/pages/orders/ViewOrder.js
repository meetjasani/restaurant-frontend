...
const ViewOrder = ({ open, handleClose, data }) => {
    const { date, orderNumber, orderType, tables, items, grossAmount, tipToWaiter, netAmount, userId, updatedAt } = data;
    return (
        <Dialog open={open} onClose={handleClose} style={{ maxWidth: 'none !important' }}>
            <DialogTitle className='order-number'>
                Order # {orderNumber}
            </DialogTitle>
            <DialogContent style={{ paddingBottom: '1px' }}>
                <div className='flex flex-col' >
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <label><b>Order Type : </b>{orderType}</label>
                    ...
                    <table style={{ width: '100%', minWidth: '700px', marginBottom: '8px' }} className="diplayTable">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>Total</td>
                                <td style={{ textAlign: 'right', paddingRight: '5px' }}>{Helper.GetFormatedAmount(tipToWaiter)}</td>
                            </tr>
                            <tr>
                                <th></th>
                                <th></th>
